...
def Binary_SWITCH_pcc_to_distance(pcc_matrix, fig_path1, fig_path2, pcc_threshold=0.7):
...
def Linear_SWITCH_pcc_to_distance(pcc_matrix, fig_path1, fig_path2, fig_path3, pcc_threshold=0.7):
...
def Nlog_SWITCH_pcc_to_distance(pcc_matrix, fig_path1, fig_path2, fig_path3, pcc_threshold=0.7):
    # Get gene symbols as vertices
    gene_symbols = pcc_matrix.index
...
def Reciprocal_SWITCH_pcc_to_distance(pcc_matrix, fig_path1, fig_path2, fig_path3, pcc_threshold=0.7):
    # Get gene symbols as vertices
    gene_symbols = pcc_matrix.index
...
def PCC_SWITCH_pcc_to_module_binary(pcc_coordinate, fig_path1, fig_path2, threshold_percentile=10, resolution_parameter=0.5, min_module_size=4, seed=123456):
...
def PCC_SWITCH_pcc_to_module_reciprocal(pcc_coordinate, fig_path1, fig_path2, threshold_percentile=10, resolution_parameter=0.5, min_module_size=4, seed=123456):
...
def PCC_SWITCH_pcc_to_module_nlog(pcc_coordinate, fig_path1, fig_path2, threshold_percentile=10, resolution_parameter=0.5, min_module_size=4, seed=123456):
...
def PCC_SWITCH_pcc_to_module_linear(pcc_coordinate, fig_path1, fig_path2, threshold_percentile=10, resolution_parameter=0.5, min_module_size=4, seed=123456):
